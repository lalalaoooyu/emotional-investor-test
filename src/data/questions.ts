...
export const questions: Question[] = [
  {
    ...
    stocks: [
      { name: "持仓股", color: "#22c55e", data: [100, 103, 108, 112, 118, 125, 129, 132] },
    ],
    labels: ["Day1", "Day2", "Day3", "Day4", "Day5", "Day6", "Day7", "今天"],
    options: [
  ...
  },
  {
    ...
    hook: "再不跑，会不会血本无归？",
    stocks: [
      { name: "持仓股", color: "#ef4444", data: [100, 101, 99, 102, 100, 98, 97, 88] },
    ],
    labels: ["", "", "", "", "", "", "昨天", "今天"],
    options: [
  ...
  },
  {
    ...
    stocks: [
      { name: "你的股票", color: "#999", data: [100, 101, 99, 100, 101, 100, 99, 100, 101, 100, 99, 100] },
      { name: "大盘指数", color: "#22c55e", data: [100, 101, 103, 105, 108, 109, 111, 113, 115, 116, 117, 118] },
    ],
    labels: ["1月", "", "", "2月", "", "", "3月", "", "", "4月", "", "今天"],
    options: [
  ...
  },
  {
    ...
    stocks: [
      { name: "错过的股票", color: "#22c55e", data: [100, 110, 125, 145, 170, 190, 200] },
      { name: "你的股票", color: "#999", data: [100, 100, 101, 102, 101, 103, 103] },
    ],
  ...
  },
  {
    ...
    hook: "抄底的机会？还是下一个陷阱？",
    stocks: [
      { name: "持仓股", color: "#e07850", data: [100, 95, 88, 82, 78, 75, 80, 81] },
    ],
    labels: ["", "", "", "", "", "最低点", "昨天", "今天"],
    options: [
  ...
  },
  {
    ...
    stocks: [
      { name: "股票A", color: "#22c55e", data: [100, 103, 107, 110, 114, 118, 120] },
      { name: "股票B", color: "#ef4444", data: [100, 98, 95, 92, 90, 87, 85] },
      { name: "股票C", color: "#999", data: [100, 100, 101, 100, 99, 100, 100] },
    ],
    labels: ["买入", "", "", "", "", "", "今天"],
    options: [
  ...
  },
  {
    ...
    stocks: [
      { name: "持仓股", color: "#22c55e", data: [80, 85, 88, 92, 95, 100, 105, 112, 120] },
    ],
    labels: ["", "", "", "", "", "前高", "", "", "新高!"],
    options: [
  ...
  },
  {
    ...
    hook: "这是系统性风险吗？会不会更惨？",
    stocks: [
      { name: "股票A", color: "#ef4444", data: [100, 99, 97, 95, 94, 93, 92] },
      { name: "股票B", color: "#f87171", data: [100, 98, 96, 93, 91, 89, 88] },
      { name: "股票C", color: "#fca5a5", data: [100, 97, 94, 91, 88, 86, 85] },
    ],
    labels: ["开盘", "", "", "", "", "", "收盘"],
    options: [
  ...
  },
  {
    ...
    stocks: [
      { name: "持仓股", color: "#e07850", data: [100, 110, 101, 107, 102, 106] },
    ],
    labels: ["周日", "周一", "周二", "周三", "周四", "今天"],
    options: [
  ...
  },
  {
    ...
    stocks: [
      { name: "大盘指数", color: "#ef4444", data: [100, 96, 92, 88, 84, 80, 77, 74, 72, 70] },
    ],
    labels: ["3个月前", "", "", "", "", "", "", "", "", "今天"],
    options: [
